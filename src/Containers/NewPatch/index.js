          ...
          {(() => {
            switch (selectedStep) {
                case 1:
                    return <HelpStep />
                case 2:
                    return <SelectStep currentStep={currentStep} handleStepSelect={handleStepSelect} navigation={navigation}/>
                case 3:
                    return <AuthStep currentStep={currentStep} handleStepSelect={handleStepSelect} navigation={navigation}/>
                case 4:
                    return <AuthFinal />
